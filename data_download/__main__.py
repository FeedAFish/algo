...
from .script.datatourisme_download import DatatoursimeDownload 
from .script.picture import Picture
...
path_state = os.path.join(BASE_DIR, "checkpoint.json")  # Fichier qui garde la progression de l'extraction pour pouvoir reprendre en cas d'arrêt
