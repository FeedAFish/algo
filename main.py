...
path_output = os.path.join(BASE_DIR, "API", "data_raw2_ndjson") # Dossier de sauvegarde des données brutes au format NDJSON
path_state = os.path.join(BASE_DIR, "API", "checkpoint2.json")  # Fichier qui garde la progression de l'extraction pour pouvoir reprendre en cas d'arrêt
